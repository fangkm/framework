...
class CONTENT_EXPORT PrimaryProcessSubThread : public PrimaryThreadImpl {
 public:
  explicit PrimaryProcessSubThread(PrimaryThread::ID identifier);
  virtual ~PrimaryProcessSubThread();
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(PrimaryProcessSubThread);
};
